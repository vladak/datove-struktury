...
\begin{pozn}
\mnote{T.Matou¹ek}
Mo¾ná by stálo za to tam dokázat Markovovu nerovnost a pak jenom øíct,
¾e to z ní plyne, proto¾e dùkaz Markova by mìl být úplnì stejný:                   
\end{pozn}
...
% XXX TODO! k jako sèítací index i optimální hodnota
\end{enumerate}
\end{proof}
