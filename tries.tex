...
\mnote{XXX k èemu patøí násl. algoritmus ? (Koubek 2002)}
\begin{algorithm}[!htb]
\caption{INSERT pro komprimované trie (?)}
...
dosadíme do odhadu \ref{odh-zak-hodnot}
a dostaneme 
...
Celý algoritmus spoèítá ulo¾ení matice M typu r x s do vektorù  \\
cd - dimenze s, \\
...
Máme vektor v dimenze $n \cdot d$ a $i_0 < i_1 < ... < i_{t-1}$ jsou v¹echny
...
smysluplné kdy¾ $d << n$ a $t < n$ (napø. $d = log(log(n))$)
