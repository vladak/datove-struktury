...
intervaly. (viz obr.~\ref{fig.bvs.example}) Tato vazba je v jednotlivými
operacemi udr¾ována.
...
která je zahrnuta do GCC\footnote{Máte-li Linux, zkuste se podívat do
