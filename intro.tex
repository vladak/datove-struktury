...
Chceme reprezentovat data, provádìt s nimi operace. Cíle téhle
pøedná¹ky jsou popsat ideje, jak datové struktury reprezentovat, popsat
...
$k$ existuje èíslo $n_k$ takové ¾e ka¾dý náhodný graf s alespon $n_k$ vrcholy
...
mìní. Nejhor¹í pøípad vlastnì \uv{uklízí} za následující nebo
