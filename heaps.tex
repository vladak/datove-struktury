...
\item lokální podmínku na uspoøádání
  - prvek reprezentující otce je men¹í ne¾ prvek repreentovaný synem
\item strukturální podmínku na stromy, ze kterých jsou vytvoøené
  - kdy¾ je prvek v sudé hladinì, pak je men¹í ne¾ prvky, které jsou
    reprezentovány jeho syny a vnuky, pokud je v liché, pak je vìt¹í (?)
    ne¾ prvky reprezentované jeho syny a vnuky.
\end{itemize}
\end{defn}
...
d(i-1)+1,d(i-1)+3,...,di+1 a otec má èíslo 
...
Alg: $d(z) = 0, d(v) = \infty \forall v \in V, v \neq z, U = {z}$\\
